export function renderArchive(data, template) {
...
const body = output.match(/<div id="chronicle-content" hidden inert>([\s\S]*)<\/div>\s*<\/body>/);
if (!body) throw new Error("Archive container missing.");
return body[1];
}
